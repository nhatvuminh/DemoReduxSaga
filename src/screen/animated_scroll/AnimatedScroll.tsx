...
type AnimatedScrollNavigationProp = StackNavigationProp<RootStackParamList, 'AnimatedScroll'>;

type AnimatedScrollProps = {
  navigation: AnimatedScrollNavigationProp;
};

export default function AnimatedScroll({navigation} : AnimatedScrollProps) {
  ...
  const animatedStyles = useAnimatedStyle(() => {
    return {
      ...
      top: interpolate(scrollOffset.value, [-50, 0, 50, 100], [1, 1, 0.5, 0.1]),
      transform: [
        {
